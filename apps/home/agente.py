...
def realizar_consulta_agente(consulta,df):
    ...
    promt_defecto = f"""Voy a realizarte una consulta para extraer información sobre un dataframe que se llama df.
      ...
      'Importe' es la columna donde tenemos en formato de número la cantidad que nos ha costado o nos han pagado por algo, todo está en euros. 
      ...
      Con esta información resuelveme la siguiente consulta, trabaja en inglés pero la respuesta final debe ser en castellano : ///{consulta}/// """
